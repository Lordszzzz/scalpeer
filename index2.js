...
const getPosts = async () => {
    ...
    const Location = "/213949389/campinas-sao-paulo/"
    ...
    await page.waitForTimeout(2000);
    await page.fill('input[name="username"]', 'sury.agency'); //suryagency

    await page.waitForTimeout(2000);
    await page.waitForSelector('input[name="password"]');

    await page.waitForTimeout(2000);
    await page.fill('input[name="password"]', `#Sury123`); //124qwras
    ...
    await page.goto(`https://www.instagram.com/explore/locations${Location}`)
    ...
    await fs.promises.writeFile(`./locations/location-${dateTimeStr}-saoPaulozl--20.json`, jsonString);
    console.log(feeds)
}
